...
for (let i=0; i<beetleInstanceData.length; i+=16) {
	...
	let age = instance.subarray(11, 12);
	...
	vec4.set(color, Math.random(), Math.random(), Math.random(), Math.random());
	pos[0] = Math.random() * world.width
	pos[1] = Math.random() * world.height
	pos[2] = Math.random() * world.depth
	age[0] = Math.random()
	let s = 0.03;
...
// 	particleData[i*8 + 0] = Math.random() * world.width;
// 	particleData[i*8 + 1] = Math.random() * world.height;
// 	particleData[i*8 + 2] = Math.random() * world.depth;
	
// 	particleData[i*8 + 4] = Math.random();
// 	particleData[i*8 + 5] = Math.random() * 10;
// 	particleData[i*8 + 6] = Math.random()+2.5;
// 	particleData[i*8 + 7] = Math.random() < 0.5 ? 0. : 1.;
// }
...
function Renderer(config) {
	...
	console.log('GL ' + glfw.GetWindowAttrib(this.window, glfw.CONTEXT_VERSION_MAJOR) + '.' + glfw.GetWindowAttrib(this.window, glfw.CONTEXT_VERSION_MINOR) + '.' + glfw.GetWindowAttrib(this.window, glfw.CONTEXT_REVISION) + " Profile: " + glfw.GetWindowAttrib(this.window, glfw.OPENGL_PROFILE));
	...
	*/
	...
	this.draw = function(t) {
		...
		glfw.SetWindowTitle(this.window, `fps ${fps}`);
		glfw.MakeContextCurrent(this.window);
